...
import { Typography, Box , Table, TableBody, TableCell, styled, TableRow} from '@mui/material';
  ...
  return (
    <>
        ...
        <Typography style={{ marginTop: 5, color: '#878787', fontSize: 14}}>
            8 Ratings & 1 Review
            <Box component="span">
                <img src={fassured} alt="flipkart" style={{ width:77, marginLeft:20}}/>
             </Box>
        </Typography>
        <Typography>
        ...
        <Table>
            <TableBody>
                ...
                <ColumnText>
                    ...
                    <TableCell>
                        <Box component="sapn" style={{ color : '#2874f0'}}>SuperComNet</Box>
                ...
                <ColumnText>
                    <TableCell colSpan={2}>
                        <img src={adURL} alt="flipkartpoint" style={{ width : 390}}/>
                    </TableCell>
                </ColumnText>
